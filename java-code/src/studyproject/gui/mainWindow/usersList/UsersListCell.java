...
public class UsersListCell extends ListCell<UserInfo> {
	...
	private final Image userImage = new Image(getClass().getResourceAsStream("/studyproject/resources/user.png"));
	private final Image sendFileImage = new Image(
			getClass().getResourceAsStream("/studyproject/resources/send-file.png"));
