...
public class Requests {
	 ...
	 * @param timestamp time of last synchronization, if 0 the client has to send a full list of all files it has
	 ...
	 * @param socketStream the stream to write the request to
	 * @param checksum the checksum of the requested file
	 * @param startIndex the index from which the other client should start reading the file
	 * @param endIndex the index at which the other client should stop reading the file
	 * @return 0 or an error value
	 */
	 ...
	 * @param socketStream the stream to write to
	 * @param size the size of the file that permission to send is asked for
	 * @param timeout the time until the request times out. Not a timestamp but a set amount of time in ms
	 * @param fileName the name of the file that permission to send is asked for
	 * @return 0 or an error value
	 */
